...
class _FoodDetailScreenState extends State<FoodDetailScreen> {
  ...
  Future<void> _load() async {
    ...
    if (found == null) {
      ...
      try {
        found = svc.firstWhere((f) => f.id == widget.foodId);
      } catch (_) {}
    }
    setState(() {
      _item = found;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
          ...
          child: Padding(
            ...
            child:
              ...
              Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                ...
                Text(AppFormatters.formatPriceShort(item.price),
      ...
      bottomNavigationBar: Container(
        padding: const EdgeInsets.fromLTRB(AppSizes.screenPadding, AppSizes.md,
        ...
        child: item.isAvailable
            ? (qty == 0
                ? CustomButton(
                    label:
                        'Add to Cart — ${AppFormatters.formatPriceShort(item.price)}',
                    onPressed: () {
  ...
  void _showMixedCanteenDialog(
      BuildContext context, CartProvider cart, FoodItemModel item) {
    showDialog(
      context: context,
