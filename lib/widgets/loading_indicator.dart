      ...
      SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            // Header
            Row(children: [
              _ShimmerBox(width: 48, height: 48, radius: AppSizes.radiusMd),
            ...
            // Banner
            _ShimmerBox(
                width: double.infinity, height: 160, radius: AppSizes.radiusXl),
            const SizedBox(height: AppSizes.lg),
            // Chips
            SingleChildScrollView(
  ...
  Widget build(BuildContext context) {
    return _shimmerWrap(
      ListView.separated(
        ...
        itemBuilder: (_, __) => _ShimmerBox(
            width: double.infinity, height: 100, radius: AppSizes.radiusLg),
      ),
    );
  }
}
